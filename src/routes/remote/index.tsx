...
export default component$(() => {
  ...
  return (
    <section class="desktop-page" aria-labelledby="remote-heading">
      <PageToolbar title="Remote listening" id="remote-heading">
        <button type="button" disabled={Boolean(state.tailscaleAction)} onClick$={() => runTailscaleAction('refresh')}>
      ...
      <div class="workspace-page remote-workspace">
        ...
        <p class="remote-privacy-note">
          The music server stays local to this computer. Tailscale Serve makes it available only to devices authorized
