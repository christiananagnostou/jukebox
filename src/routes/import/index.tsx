...
export default component$(() => {
  ...
  return (
    <section class="desktop-page" aria-labelledby="import-heading">
      <PageToolbar title="Import music" id="import-heading">
        <div class="page-toolbar-strip">
          <button type="button" onClick$={chooseFolders} disabled={busy.value}>
