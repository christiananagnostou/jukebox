...
export const KEYBOARD_COMMAND_GROUPS: readonly KeyboardCommandGroup[] = [
  {
    ...
    title: 'Movement',
    commands: [
      { key: 'j', command: 'Move selection down' },
      { key: 'k', command: 'Move selection up' },
      { key: 'h', command: 'Move left or up a folder' },
      { key: 'l', command: 'Move right or open a folder' },
      { key: 'g', command: 'Move to the first song' },
      { key: 'G', command: 'Move to the last loaded song' },
    ],
  },
  {
    type: 'header',
    title: 'Playback',
    commands: [
      { key: 'Enter', command: 'Play the current selection' },
      { key: 'p', command: 'Play or pause' },
      { key: 'n', command: 'Next track' },
      { key: '⇧ N', command: 'Previous track' },
      { key: 'q', command: 'Add selected song to queue' },
    ],
  },
