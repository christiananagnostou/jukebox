...
| [004](004-playlists-queue-and-history.md)         | Durable collections, queue, and history                         | IN PROGRESS — stable native queue entries, desktop parity, committed session/queue persistence, bounded history-powered built-ins, and duplicate-preserving manual-playlist workflows are complete; plans 038-040 and 042-044 await native QA, while editable smart rules, multi-select, and M3U interoperability remain |
