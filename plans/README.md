...
Reconciled by the `improve` audit on 2026-08-26. Execute focused plans 007-033 in the order below unless dependencies say otherwise. Each executor must read its plan fully, honor its STOP conditions, run every verification gate, and update the status row when done.
...
| ------------------------------------------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [001](001-quality-security-release-foundation.md) | Migrations, diagnostics, permissions, identity, release quality | IN PROGRESS — migrations, diagnostics, Rust quality gates, portability, build-path remapping, renderer SQL narrowing, and renderer filesystem-plugin removal are complete; CSP/asset scopes, identity migration, Windows, signing, and updater remain |
